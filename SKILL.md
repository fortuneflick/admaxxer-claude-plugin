---
name: admaxxer
description: Read a marketing workspace's ad accounts, revenue attribution and web analytics through Admaxxer, and run campaign-level ad ops the person approves in the conversation. Use when asked about ad spend, ROAS, MER, attribution or traffic, when a campaign needs pausing or a budget change, or when building a new campaign from an agent.
---
